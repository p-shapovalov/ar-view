...
//        // Read the texture.
//        Bitmap textureBitmap = BitmapFactory.decodeByteArray(byteArray, 0, byteArray.length);
//
...
//    }
//
//    public void draw(Context context, float[] cameraView, float[] cameraPerspective) {
//        if (mTextures[0] == 0) {
