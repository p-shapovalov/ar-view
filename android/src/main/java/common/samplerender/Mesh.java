...
public class Mesh implements Closeable {
  ...
  // createFromAsset(...) was removed: it required the de.javagl.obj dependency for
  // Wavefront OBJ parsing, which this plugin doesn't use. Construct meshes via the
  // VertexBuffer/IndexBuffer constructor above instead.
