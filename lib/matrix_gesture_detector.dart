...
typedef MatrixValidationFunction = bool Function(
    Matrix4 matrix,
    Matrix4 translationDeltaMatrix,
    Matrix4 scaleDeltaMatrix,
    Matrix4 rotationDeltaMatrix);
...
class MatrixGestureDetector extends StatefulWidget {
  ...
  final MatrixValidationFunction? validateMatrix;
...
class MatrixGestureDetectorState extends State<MatrixGestureDetector> {
  ...
  void onScaleUpdate(ScaleUpdateDetails details) {
    ...
    if (widget.validateMatrix != null &&
        !widget.validateMatrix!(temp, translationDeltaMatrix, scaleDeltaMatrix,
            rotationDeltaMatrix)) {
      return;
    }
    matrix = temp;
